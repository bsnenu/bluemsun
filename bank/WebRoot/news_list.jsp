...
<body style="background:black;">
    <div class="container">
        ...
        <div class="wrap">
           <div class="panel panel-primary news_div">
                      ...
                      <div class="panel-body">
                        <ul class="list-group">
                        	<c:forEach items="${newsList }" var="news" varStatus="vs">
	                            	...
	                            	<span class="li_number">${vs.index+1 }</span>
		                            <a target="_blank" href="${basePath }/user/news/getNewsById?nid=${news.nid}">${news.nname }</a>
		                            <span class="date_t"> <fmt:formatDate value="${news.ntime }" type="both" /></span>
	                             </li>
                        	</c:forEach>
